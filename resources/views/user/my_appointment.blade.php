...
<body>
  ...
  <div align="center" style="padding-top: 100px;">
    <table>
        ...
        <tr style="background-color:rgb(227, 227, 227);" align="center">
            ...
            <td><a onclick="return confirm('Are you sure to cancel this?')" class="bt btn-danger" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a></td>
